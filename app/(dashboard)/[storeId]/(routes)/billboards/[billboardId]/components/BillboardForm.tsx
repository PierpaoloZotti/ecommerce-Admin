...
const formSchema = z.object({
  label: z.string().min(2, { message: "Deve conter pelo menos 2 caracteres" }),
  imageUrl: z.string().min(2, { message: "Deve conter pelo menos 2 caracteres" }),
});
...
export const BillboardForm: React.FC<BillboardFormProps> = ({ initialData }) => {
  ...
  const toastMesages = initialData ? "Billboard atualizado" : "Billboard criado";
      ...
      <Form {...form}>
        ...
        >
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Papel de parede</FormLabel>
                <FormControl>
                  <ImageUpload
          ...
          <div className='grid grid-cols-3 gap-8'>
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Nome billboard</FormLabel>
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder='Nome billboard'
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
